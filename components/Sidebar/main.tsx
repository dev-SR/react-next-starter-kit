            ...
            <div className='flex flex-no-wrap'>
               ...
               <div className='absolute lg:relative w-64 h-screen shadow bg-white hidden lg:block'>
                  ...
                  <ul
                     ...
                     className='bg-white rounded py-6'>
                     <li
                        ...
                        {menu ? (
                           <ul className='pt-2 '>
                              <li className='pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2'>
                                 Stats
                              </li>
                              <li className='pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2'>
                                 Lists
                              </li>
                              <li className='pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 flex items-center ml-2'>
                                 Tables
                              </li>
                           </ul>
                        ) : (
                     ...
                     <li
                        ...
                        {menu1 ? (
                           <ul className='pt-2 '>
                              <li className='pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2'>
                                 Stats
                              </li>
                              <li className='pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2'>
                                 Lists
                              </li>
                              <li className='pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 flex items-center ml-2'>
                                 Tables
                              </li>
                           </ul>
                        ) : (
                        ...
                        <div>
                           ...
                           <ul
                              ...
                              <li
                                 ...
                                 {menu ? (
                                    <ul className='pt-2 '>
                                       <li className='pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base'>
                                          Stats
                                       </li>
                                       <li className='pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base'>
                                          Lists
                                       </li>
                                       <li className='pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 flex items-center ml-2 xl:text-base md:text-2xl text-base'>
                                          Tables
                                       </li>
                                    </ul>
                                 ) : (
                              ...
                              <li
                                 ...
                                 {menu1 ? (
                                    <ul className='pt-2 '>
                                       <li className='pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base'>
                                          Stats
                                       </li>
                                       <li className='pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base'>
                                          Lists
                                       </li>
                                       <li className='pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 flex items-center ml-2 xl:text-base md:text-2xl text-base'>
                                          Tables
                                       </li>
                                    </ul>
                                 ) : (
